...
function getResetPasswordHtmlEmail(token) {
    const feUrl = `${config_1.default.get('frontendDomain')}/resetHesla/${token}`;
...
exports.default = getResetPasswordHtmlEmail;
//# sourceMappingURL=getPasswordHtmlEmail.js.map