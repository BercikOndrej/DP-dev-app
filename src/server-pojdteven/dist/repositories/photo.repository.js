...
let PhotoRepository = class PhotoRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Photo, dataSource);
    }
};
exports.PhotoRepository = PhotoRepository;
exports.PhotoRepository = PhotoRepository = tslib_1.__decorate([
