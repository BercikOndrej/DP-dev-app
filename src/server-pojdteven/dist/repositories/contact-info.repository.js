...
let ContactInfoRepository = class ContactInfoRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.ContactInfo, dataSource);
    }
};
exports.ContactInfoRepository = ContactInfoRepository;
exports.ContactInfoRepository = ContactInfoRepository = tslib_1.__decorate([
